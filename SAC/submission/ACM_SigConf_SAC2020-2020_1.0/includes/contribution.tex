...
\begin{figure}[h]
\centering
\includegraphics[scale=0.3]{images/boxplot_freq}
\caption{Distribution of word frequencies in the text8 datasedt}
\label{fig:boxplot_freq}
\end{figure} 
This shows that very few words are responsible for the majority of the context pairs. For example the word \textit{the} creates 50\% of the pairs in the text8 dataset. Therefore if we create batches, the word the will appear multiple time and the learning will be hindered. 