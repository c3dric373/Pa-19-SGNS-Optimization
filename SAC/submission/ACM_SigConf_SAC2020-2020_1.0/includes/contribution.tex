...
\subsection{Optimization of the quality of batches}
...
This technique drastically reduces the data set size,by deleting words that appear very frequently, it therefore reduces the number of very small batches. 
