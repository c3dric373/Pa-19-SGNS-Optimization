...
To summarize, we deleted words that appear very often (subsampling) and very infrequently (min count) from our dataset, i.e text8 dataset. To evaluate our word embeddings we defined the cosine distance and will compare our embeddings to a human judged dataset of pairs of words based on their similarity. The reader was also given an explanation about the configuration of our network and input shuffling. With all this knowledge we can know present the achieved experimental results in the next section.
