...
\caption{Example of a sentence with different sampling tresholds}
    ...
    \begin{tabular}{l l}%
        \toprule
Sampling Treshhold & 0 \\ 

        \midrule%
Sampling Treshold & First sentence of Dataset \\ \hline
$10^{-1}$ &Anarchism originated as a term of abuse first\tabularnewline used against early working class radicals \tabularnewline including the diggers of the english \\ \hline
$10^{-2}$ & Anarchism originated as a term of abuse first used against early \tabularnewline working class radicals including diggers of english \\ \hline
$10^{-3}$ & Anarchism originated a term abuse first used against early \tabularnewline working class radicals including diggers the english\\ \hline
$10^{-4}$ & Anarchism originated abuse used against working class radicals\tabularnewline diggers english \\ \hline
