...
In theory Adadelta \cite{adadelta} should outperform Adagrad as it's an extension of the former. Adadelta doesn't  have any learning rate to tune, therefore we only did 2 experiments, with and without input shuffling. 
